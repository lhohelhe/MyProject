    ...
    <main class="flex-1 px-8 py-8 overflow-y-auto">
        ...
        @else
            <div class="grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                @foreach($buku as $b)
                <div class="relative flex flex-col items-center bg-white rounded-[12px] shadow-[0px_3px_10px_0px_rgba(0,0,0,0.15)] overflow-hidden cursor-pointer hover:shadow-[0px_6px_16px_0px_rgba(0,0,0,0.2)] transition-shadow">
